...
function showFormAvatar(providerId){
    let form = "";
    form += "<input type=\"file\"\n" +
        "       id=\"image\" name=\"image\"\n" +
        "       accept=\"image/png, image/jpeg\"><br>"
        + "<button onclick=\"saveAvatar("+ providerId +")\">Save</button>"
    document.getElementById("display").innerHTML = form;
}
function saveAvatar(providerId){
    ...
    $.ajax({
        ...
        type: "POST",
        url: "http://localhost:8080/avatar/upload/avatar" + providerId,
        data: formData,
        success: function () {
            alert("done");
        }
